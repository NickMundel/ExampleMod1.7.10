...
import com.mrjake.aunis.particle.ParticleBlender;
import com.mrjake.aunis.particle.ParticleBlenderSmoke;
import com.mrjake.aunis.particle.ParticleBlenderSparks;
...
public class StargateOrlinRenderer extends StargateAbstractRenderer<StargateAbstractRendererState> {
	...
	protected void renderGate(StargateAbstractRendererState rendererState, double partialTicks) {
		GL11.glRotatef(rendererState.horizontalRotation, 0, 1, 0);
	...
	private static final ParticleBlender.RandomizeInterface SPARK_RANDOMIZER = new ParticleBlender.RandomizeInterface() {

		@Override
		public void randomize(ParticleBlender.SimpleVector motion) {
