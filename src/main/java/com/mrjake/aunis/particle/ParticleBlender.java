...
import com.mrjake.aunis.renderer.stargate.StargateOrlinRenderer;
...
public abstract class ParticleBlender {
	 ...
	 * @return
	 */
	protected abstract EntityFX createParticle(World world, double x, float y, double z, double motionX, double motionZ, boolean falling);
