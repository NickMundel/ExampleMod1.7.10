...
public class Texture {
    ...
    public Texture(BufferedImage bufferedImage, boolean desaturate) {
        ...
        if (desaturate) {
            Aunis.LOG.info("Started desaturation of the event horizon texture");
            ...
            Aunis.LOG.info("Finished desaturation of the event horizon texture");
...
//        	}
    ...
    private static class RasterThread extends Thread {
        ...
        @Override
        public void run() {
            Aunis.LOG.debug(String.format("Starting thread (%d, %d) to (%d, %d)", x, y, x+w, y+h));
            ...
            Aunis.LOG.debug(String.format("Finished thread (%d, %d) to (%d, %d)", x, y, x+w, y+h));
        }
    }
}
