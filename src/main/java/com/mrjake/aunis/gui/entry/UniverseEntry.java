...
public class UniverseEntry extends AbstractAddressEntry {
	...
	public UniverseEntry(Minecraft mc, int index, int maxIndex, String name, ActionListener reloadListener, SymbolTypeEnum type, StargateAddress addr, int maxSymbols) {
