...
public class OCAddMessageGui extends GuiScreen {
	...
	public OCAddMessageGui(@Nullable GuiScreen parentScreen) {
	...
	public void initGui() {
		...
		for (int i=0; i<labels.length; i++) {
			LabeledTextBox textBox = new LabeledTextBox(fontRendererObj, guiLeft, guiTop, i, 0, 42*i, labels[i]);
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		if (isPortInvalid)
			drawString(fontRendererObj, TextFormatting.DARK_RED + I18n.format("item.aunis.universe_dialer.oc_port_invalid"), guiLeft+245, guiTop+103, 0x00FFFFFF);
	}
