...
import com.mrjake.aunis.gui.BetterButton.ActionCallback;
...
public class BetterTextField extends GuiTextField {
	...
	public BetterTextField( FontRenderer fontrendererObj, int x, int y, int width, int height, String originalContent) {
