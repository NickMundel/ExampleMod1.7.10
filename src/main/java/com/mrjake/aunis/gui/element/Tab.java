...
public abstract class Tab {
	...
	public void render(FontRenderer fontRenderer, int mouseX, int mouseY) {
		...
		Gui.func_146110_a(guiLeft+currentOffsetX, guiTop+defaultY, bgTexX, bgTexY, width, height, textureSize, textureSize);
		Gui.func_146110_a(guiLeft+iconX+currentOffsetX, guiTop+defaultY+iconY, iconTexX, iconTexY, iconWidth, iconHeight, textureSize, textureSize);
	...
	public void animateTo(int targetOffsetX, int animationTime) {
		...
		animationStart = Minecraft.getMinecraft().theWorld.getTotalWorldTime();
	...
	public void updateAnimation(Minecraft mc) {
		...
		if (animate) {
			float effTick = mc.theWorld.getTotalWorldTime() - animationStart + mc.getRenderPartialTicks();
    ...
    public class SlotTab extends Slot {
        ...
        public SlotTab(IInventory inventory, int slotIndex, int xPos, int yPos, UpdateSlotPositionInterface updateSlotPosition) {
        ...
        public SlotTab(Slot slot) {
            new SlotTab(slot.inventory, slot.getSlotIndex(), slot.xDisplayPosition, slot.yDisplayPosition, new UpdateSlotPositionInterface() {
                @Override
